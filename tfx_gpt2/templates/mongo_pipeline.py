...
def create_pipeline(pipeline_name, pipeline_root, model_name, train_config, mongo_ip, mongo_colnames,
                    mongo_port="27017", encoding='utf-8', combine=50000, enable_cache=False):
